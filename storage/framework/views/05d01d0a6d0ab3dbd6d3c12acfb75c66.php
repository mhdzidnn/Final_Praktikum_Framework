...
unset($__errorArgs, $__bag); ?>" id="name" name="name" value="<?php echo e(old('name')); ?>" placeholder="Nama Lengkap" required autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>" id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Alamat Email" required autocomplete="email">
...
unset($__errorArgs, $__bag); ?>" id="password" name="password" placeholder="Kata Sandi" required autocomplete="new-password">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?php echo e(url('/login')); ?>">Sudah punya akun? Masuk!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH C:\Users\Dell\Downloads\latihan_modul8-auth-master\resources\views/auth/register.blade.php ENDPATH**/ ?>